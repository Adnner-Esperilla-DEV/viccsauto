    ...
    <div className="sm:col-span-2">
      ...
      <div className="flex items-end justify-between gap-4">
        <span className="text-sm font-bold text-slate-700">
          {title} <span className="font-normal text-slate-400">(opcional)</span>
        </span>
            ...
            >
              ...
              <div className="border-t border-slate-100 p-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button type="button" onClick={() => removeImage(index)} className="text-xs font-bold text-red-700">
                    Quitar
                  </button>
                </div>
                {index > 0 && (
            ...
            <b className="block text-sm text-slate-800">
              {processing
                ...
                : images.length
                  ...
                  : `Seleccionar hasta ${maxImages} imágenes`}
            </b>
            <small className="text-slate-500">
              La primera será la portada. Se ajustan a 4:3 y se convierten a WebP.
            </small>
          </span>
          <input
            ref={inputRef}
